...
"""
This script imports a Wavefront OBJx files to Blender.

Usage:
Run this script from "File->Import" menu and then load the desired OBJx file.
...
def load(context,
    ...
    with ProgressReport(context.window_manager) as progress:
        progress.enter_substeps(1, "Importing OBJx %r..." % filepath)
        ...
        progress.enter_substeps(3, "Parsing OBJx file...")
